...
return (
    ...
    <div className="max-w-xl mx-auto my-10 p-8 rounded-xl shadow-lg bg-gradient-to-br from-blue-100 to-white">
        ...
        <p className="text-gray-800 text-lg leading-relaxed mb-4">
            ...
            With over 5 years of sewing experience, our clothing line company has stood tall among its peers.</p>
        {showMore && (
            ...
            aesthetic designs & styles we have brought into the fashion industry, our unique way of combining art with simplicity makes our garments unique.
    We are Skilled in various sets from traditional and modern-day wears to Ankara and Corporate wears, our works know no limits. </p>
        )}
        <button
