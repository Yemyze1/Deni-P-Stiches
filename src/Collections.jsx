    ...
    <section id= 'collections' className="py-16 px-6 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded shadow p-6 flex flex-col items-center">
          <img src="./fair lady in ankara copy.jpg" alt="Fair Lady in Ankara" className="mb-4 rounded-2xl  object-cover transition duration-300 hover: hover:scale-70" />
        ...
        <div className="bg-white rounded shadow p-6 flex flex-col items-center">
             <img src="./ankara designs.jpg" alt="Fair Lady in Ankara" className="mb-4 rounded -3x1  object-cover transition duration-300 hover: hover:scale-75" />
        ...
        <div className="bg-white rounded shadow p-6 flex flex-col items-center">
             <img src="./ankara with headtie.jpg" alt="A young Tailor" className="mb-4 rounded-2xl  object-cover transition duration-300 hover: hover:scale-75" />
